...
debugSource("~/Documents/anomaly-detection-ngsim/lanechange/vwp_libc_wishart_wishart.R")
...
alpha_cp <- 1e-126 # the rate at which the time series will decide to open a larger number of changepoints that other time series has not yet considered
